...
DROP FUNCTION IF EXISTS poc.SDO_ConvertToLrsGeom(BINARY);
...
DROP FUNCTION IF EXISTS poc.SDO_MinMbrOrdinate(BINARY, INT);
...
CREATE FUNCTION poc.SDO_ConvertToLrsGeom(BINARY)            RETURNS BINARY LOCATION '/jars/hive-udf-extensions-1.0.0.jar' SYMBOL='io.datadynamics.hive.udf.esri.oracle.SDO_ConvertToLrsGeom';
